...
<section class="section">
  ...
  <!-- Animated WC 2026 neon background -->
...
<style>
  ...
  /* ── WC 2026 neon background sweep ── */

  /* Primary sweep: diagonal, 15s */
  ...
  /* Secondary sweep: counter-diagonal, 22s */
  ...
  .bg-anim {
    ...
    pointer-events: none;
    z-index: 0;
    /* Primary gradient: electric blue → vivid red → electric purple → neon cyan */
  ...
  /* Second layer sweeps counter-direction for depth */
  .bg-anim::after {
    content: '';
    position: absolute;
    inset: 0;
